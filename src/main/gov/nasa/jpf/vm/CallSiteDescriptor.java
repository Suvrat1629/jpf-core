...
public final class CallSiteDescriptor {
    ...
    public CallSiteDescriptor(String ownerClassName, String invokedName, String invokedDescriptor) {
     ...
     */
    public CallSiteDescriptor(String ownerClassName, String invokedName, String invokedDescriptor, String[] componentTypeNames) {
        this.ownerClassName = ownerClassName;
        this.invokedName = invokedName;
        this.invokedDescriptor = invokedDescriptor;
